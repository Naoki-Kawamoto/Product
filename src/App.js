...
<tbody>
  <tr>
    <th>お名前</th>
      <td colspan="2"><input type="text" name="your-name" placeholder="お名前" value="" aria-required="true" aria-invalid="false"> 様</td>
  </tr>

  <tr>
    <th>お名前（フリガナ）</th>
      <td colspan="2"><input type="text" name="your-name" placeholder="カナ" value="" aria-required="true" aria-invalid="false"> 様</td>
  </tr>

  <tr>
    <th>年齢</th>
      <td colspan="2"><input type="number" name="you-age" placeholder="年齢" value=""  max="120" aria-required="true" aria-invalid="false"> 歳</td>
  </tr>
  <tr>
    <th>性別</th>
      <td><label><input type="radio" name="your-sex" value="男性">男性</label><label><input type="radio" name="your-sex" value="女性">女性</label></td>
  </tr>

  <tr>
    <th>身長</th>
      <td colspan="2"><input type="number" step="0.1" name="your-height" placeholder="身長" value="" aria-required="true" aria-invalid="false"> cm</td>
  </tr>

  <tr>
    <th>体重</th>
      <td colspan="2"><input type="number" step="0.01" name="your-weight" placeholder="体重" value="" aria-required="true" aria-invalid="false"> kg</td>
  </tr>

  <tr>
    <th>BMI</th>
      <td colspan="2"><input type="number" name="BMI" value="" aria-invalid="false" placeholder="BMI"></td>
  </tr>

  <tr>
    <th>腹囲</th>
      <td colspan="2"><input type="number" name="waist" placeholder="腹囲" step="0.1" value="" aria-required="true" aria-invalid="false"> cm</td>
  </tr>

  <tr>
    <th>心拍数</th>
      <td colspan="2"><input type="number" name="heart_rate" placeholder="心拍数" step="1" value="" aria-required="true" aria-invalid="false"> 回/1分</td>
  </tr>

  <tr>
    <th>脈拍</th>
      <td colspan="2"><input type="number" name="pusle" placeholder="脈拍" step="1" value="" aria-required="true" aria-invalid="false"> 回/1分</td>
  </tr>

  <tr>
    <th>呼吸数</th>
      <td colspan="2"><input type="number" name="respiratory_rate" placeholder="呼吸数" step="1" value="" aria-required="true" aria-invalid="false"> 回/1分</td>
  </tr>

  <tr>
    <th>SPO2</th>
      <td colspan="2"><input type="number" name="SPO2" placeholder="SPO2" step="0.1" value="" aria-required="true" aria-invalid="false"> %</td>
  </tr>

  <tr>
    <th>血圧</th>
      <td>最高（平均値）<br><input type="number" name="blood-pressure-max" placeholder="最高血圧（平均値）" value="" aria-required="true" aria-invalid="false"> mmHg</td>
      <td>最低（平均値）<br><input type="number" name="blood-pressure-min" placeholder="最低血圧（平均値）" value="" aria-required="true" aria-invalid="false"> mmHg</td>
  </tr>
  <tr>
    <th>視力（裸眼）</th>
  ...
  <tr>
    <th>肺活量</th>
      <td>努力肺活量<br><input type="number" name="effort-lung-capacity" placeholder="努力肺活量" step="0.01" value=""  aria-required="true" aria-invalid="false"> l</td>
      <td>1秒量<br><input type="number" name="minite-lung-capacity" placeholder="1秒量" step="0.01" value=""  aria-required="true" aria-invalid="false"> l</td>
      <td>1秒率<br><input type="number" name="minute-lung-rate" placeholder="1秒率" step="0.01" value=""  aria-invalid="false"> %</td>
  </tr>

  <tr>
    <th>肝機能①</th>
      <td>AST(GOT)<br><input type="number" name="AST" placeholder="AST(GOT)" step="1" value="" aria-required="true" aria-invalid="false"> IU/L</td>
      <td>ALT(GOT)<br><input type="number" name="ALT" placeholder="ALT(GOT)" step="1" value="" aria-required="true" aria-invalid="false"> IU/L</td>
  </tr>

  <tr>
    <th>肝機能②</th>
      <td>ALP<br><input type="number" name="ALP" placeholder="ALP" step="1" value="" aria-required="true" aria-invalid="false"> U/L</td>
      <td>γ-GT<br><input type="number" name="γ-GT" placeholder="γ-GT" step="1" value="" aria-required="true" aria-invalid="false"> IU/L</td>
  </tr>

  <tr>
    <th>総蛋白</th>
      <td><input type="number" name="total-protein" placeholder="総蛋白" step="0.1" value="" aria-invalid="false"> g/dl</td>
  </tr>

  <tr>
    <th>アルブミン</th>
      <td><input type="number" name="albumin" placeholder="アルブミン" step="0.1" value="" aria-invalid="false"> g/dl</td>
  </tr>

  <tr>
    <th>LD</th>
      <td><input type="number" name="LD" placeholder="LD" step="1" value=""  aria-invalid="false"> IU/L</td>
  </tr>

  <tr>
    <th>総ビリルビン</th>
      <td><input type="number" name="total-bil" placeholder="総ビリルビン" step="0.1" value="" max="3" aria-required="true" aria-invalid="false">mg/dl</td>
  </tr>

  <tr>
    <th>血清アミラーゼ</th>
      <td><input type="number" name="serum-amylase" placeholder="血清アミラーゼ" step="1" value="" aria-invalid="false"> IU/L</td>
  </tr>

  <tr>
    <th>コレステロール</th>
      <td>総コレステロール<br><input type="number" name="total-cholesterol" placeholder="総コレステロール" value="" aria-required="true" aria-invalid="false"> mg/dl</td>
      <td>LDLコレステロール<br><input type="number" name="LDL-cholesterol" placeholder="LDLコレステロール" value="" aria-required="true" aria-invalid="false"> mg/dl</td>
      <td>HDLコレステロール<br><input type="number" name="HDL-cholesterol" placeholder="HDLコレステロール" value="" aria-required="true" aria-invalid="false"> mg/dl</td>
  </tr>
